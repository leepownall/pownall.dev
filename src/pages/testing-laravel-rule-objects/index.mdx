...
export const meta = {
  ...
  description: `Laravel gives you the ability to create custom validation rules using rule objects. How do you test them?`,
  date: '2021-02-03T20:05:00Z'
}
...
these allow you to create any validation rules you want. How do you test them?
