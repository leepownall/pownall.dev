...
const siteUrl = 'https://pownall.dev'

const feed = new Feed({
  title: 'Lee Pownall',
  description: 'Posts from Lee Pownall',
  id: siteUrl,
  link: siteUrl,
  language: 'en',
  image: `${siteUrl}/favicon-32x32.png`,
  favicon: `${siteUrl}/favicon.ico`,
  copyright: `All rights reserved ${new Date().getFullYear()}, Lee Pownall`,
  feedLinks: {
  ...
  author: {
    name: 'Lee Pownall',
    link: 'https://twitter.com/@leepownall',
  },
})
